...
test('acesso por senha, reserva sem conta e exportação',async t=>{
  ...
  await t.test('nome e telefone bastam para reservar sem login',async()=>{
    let slot;
    ...
    const body={serviceIds:['srv-corte'],professionalId:slot.professionalId,startAt:slot.startAt,quoteRevision:slot.quoteRevision,name:'=Teste planilha segura',phone:'12999999999',idempotencyKey:key};
