...
export const metadata: Metadata = {
  ...
  appleWebApp: { capable: true, title: 'Nexius Barber', statusBarStyle: 'black-translucent' },
};

export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="pt-BR" className="dark">
      <body className={`${archivo.variable} ${archivoBlack.variable}`}><RouteMotion>{children}</RouteMotion></body>
    </html>
  );
}
